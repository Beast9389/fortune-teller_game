...
const GAMES = [
  ...
  { id: "soulmate", name: "Soulmate Quiz", tagline: "10 questions, one honest match", icon: Heart, accent: "#FF5C8A", live: true, path: `${import.meta.env.BASE_URL.replace(/\/$/, '')}/soulmate-quiz` },
  { id: "fortune", name: "AI Fortune Teller", tagline: "AI-written readings, offline-safe", icon: Moon, accent: "#B45CFF", live: true, path: `${import.meta.env.BASE_URL.replace(/\/$/, '')}/fortune-teller` },
  { id: "palm", name: "Palm Reader", tagline: "Scan your palm, on your device only", icon: Hand, accent: "#22D3EE", live: true, path: `${import.meta.env.BASE_URL.replace(/\/$/, '')}/palm-reader` },
  { id: "elemental", name: "Elemental Matcher", tagline: "Zodiac element × personality compatibility", icon: Flame, accent: "#8B5CF6", live: true, path: `${import.meta.env.BASE_URL.replace(/\/$/, '')}/astro-matcher` },
  { id: "scrying", name: "The Scrying Pool", tagline: "Real water physics, a real oracle", icon: Waves, accent: "#5B8DEF", live: true, path: `${import.meta.env.BASE_URL.replace(/\/$/, '')}/scrying-pool.html` },
  ...
  return (
    <footer className="site-footer">
      <div className="footer-links">
        <a href={`${import.meta.env.BASE_URL.replace(/\/$/, '')}/about`}>About Us</a>
        <a href={`${import.meta.env.BASE_URL.replace(/\/$/, '')}/paper-fortune-teller`}>How to Make a Paper Fortune Teller</a>
        <a href={`${import.meta.env.BASE_URL.replace(/\/$/, '')}/privacy`}>Privacy Policy</a>
        <a href={`${import.meta.env.BASE_URL.replace(/\/$/, '')}/terms`}>Terms &amp; Conditions</a>
        <a href={`${import.meta.env.BASE_URL.replace(/\/$/, '')}/contact`}>Contact Us</a>
      </div>
